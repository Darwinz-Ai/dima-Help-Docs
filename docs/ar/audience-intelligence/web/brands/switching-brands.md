...
1. **فتح قائمة التبديل (Open the Switcher):** حدد موقع وانقر على أيقونة شركتك الحالية في الزاوية السفلية من الشريط الجانبي.
2. **اختيار علامة تجارية (Select a Brand):** ستظهر قائمة تعرض جميع الشركات التي لديك حق الوصول إليها. انقر على العلامة التجارية المطلوبة من القائمة للتبديل فورًا.
3. **البحث (اختياري) (Search):** إذا كنت تدير عددًا كبيرًا من العلامات التجارية، فاكتب اسم الشركة في شريط البحث أعلى القائمة للعثور عليها بسرعة.
