---
label: تحديد جميع الإشعارات كمقروءة
description: >-
  تعرّف على كيفية فتح قائمة الإشعارات، وتحديد جميع الإشعارات كمقروءة، ثم تأكيد
  الإجراء.
order: 4
readingTime: 1
---
...
يتيح تحديد جميع الإشعارات كمقروءة للمستخدمين تعليم كل إشعارات تطبيق ديما بسرعة على أنها مقروءة. ما على المستخدم إلا فتح صفحة الإشعارات، واختيار خيار تحديد الكل كمقروء، ثم تأكيد الإجراء.

هذا المسار مخصص للمستخدمين الذين يرغبون في مسح جميع الإشعارات غير المقروءة دفعة واحدة.
